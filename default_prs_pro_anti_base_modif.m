...
prs.baseline_win = [-0.5 0]; % tryout  %[-0.3 -0.1];  % before saccade onset  0.6-0
prs.instruction_win = [0.05 0.350];  % aligned to trial onset
% prs.saccade_win = [-0.101 0.201];   % aligned to saccade << default
prs.saccade_win = [-0.150 0.250]; %[0.1 0.201];   %[-0.050 0.150];


% extract spk timing
prs.tspk = [-0.7 0.2]; % tryout  % [-0.1 0.2]; %100 ms before trial starts to reward +200 ms
...
prs.binwidth = 0.01;
prs.timepoints_instr = -0.7:prs.binwidth:1;
