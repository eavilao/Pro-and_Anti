...
% % neuronList(38).depth = 35.1; %not real
% % neuronList(38).gridLocation = [23 5]; %not real
...
% % % neuronList(41).gridLocation = [23 5]; %not real
...
% % % neuronList(42).gridLocation = [23 5]; %not real
...
% % % neuronList(51).depth =  18 ; % not real - driver depth missing  
...
% % % neuronList(56).depth =  18 ; % not real - driver depth missing  
...
% % % neuronList(57).depth =  18 ; % not real - driver depth missing  
...
% % % neuronList(59).depth =  18 ; % not real - driver depth missing  
...
% % % neuronList(60).depth =  18 ; % not real - driver depth missing  
...
% % % neuronList(66).depth =  18  ;% not real - 
...
% neuronList(67).depth =  18 ; % not real - 
...
% neuronList(71).depth =  18 ;  % not real 
...
% neuronList(85).depth =  18  ; % not real 
...
% neuronList(86).depth =  18  ; % not real 
...
% neuronList(90).depth =  18;   % not real 
...
% neuronList(91).depth =  18 ; % not real 
...
% neuronList(92).depth =  18  ; % not real 
