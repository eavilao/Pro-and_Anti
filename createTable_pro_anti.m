...
%% instr
indx_vermis_sign = (indx_pro_only_sacc_exc_omv | indx_only_sacc_sup_omv | indx_anti_only_sacc_exc_omv | indx_anti_only_sacc_sup_omv | indx_pro_anti_sacc_exc_omv | indx_pro_anti_sacc_sup_omv); 
...
indx_sign_instrDir_instr_pro_lat(i) = units(indx_lateral(i)).stats.pro.flags.instrDirVSinstr_nspk;
indx_sign_instrDir_instr_anti_lat(i) = units(indx_lateral(i)).stats.anti.flags.instrDirVSinstr_nspk;
indx_sign_goCue_instrDir_pro_lat(i) = units(indx_lateral(i)).stats.pro.flags.goCueVSinstrDir_nspk;
indx_sign_goCue_instrDir_anti_lat(i) = units(indx_lateral(i)).stats.anti.flags.goCueVSinstrDir_nspk;
indx_sign_saccVSinstrDir_nspk_pro_lat(i) = units(indx_lateral(i)).stats.pro.flags.saccVSinstrDir_nspk;
indx_sign_saccVSinstrDir_nspk_anti_lat(i) = units(indx_lateral(i)).stats.anti.flags.saccVSinstrDir_nspk;
indx_exc_sacc_pro_lat(i) = units(indx_lateral(i)).pro.neural.exc; 
indx_sup_sacc_pro_lat(i) = units(indx_lateral(i)).pro.neural.sup; 
indx_exc_sacc_anti_lat(i) = units(indx_lateral(i)).anti.neural.exc; 
indx_sup_sacc_anti_lat(i) = units(indx_lateral(i)).anti.neural.sup;
indx_exc_instr_pro_lat(i) = units(indx_lateral(i)).pro.neural.exc_instr;
indx_exc_instr_anti_lat(i) = units(indx_lateral(i)).anti.neural.exc_instr;
indx_sup_instr_pro_lat(i) = units(indx_lateral(i)).pro.neural.sup_instr;
indx_sup_instr_anti_lat(i) = units(indx_lateral(i)).anti.neural.sup_instr;
indx_sign_sacc_pro_exc_sup_lat(i) = units(indx_lateral(i)).pro.neural.exc_sup_flag;
indx_sign_instr_pro_exc_sup_lat(i) = units(indx_lateral(i)).pro.neural.exc_sup_flag_instr;
indx_sign_sacc_anti_exc_sup_lat(i) = units(indx_lateral(i)).anti.neural.exc_sup_flag;
indx_sign_instr_anti_exc_sup_lat(i) = units(indx_lateral(i)).anti.neural.exc_sup_flag_instr;
...
pro_only_instr_lat = sum(indx_sign_instr_base_pro_lat & ~indx_sign_instr_base_anti_lat)
anti_only_instr_lat = sum(indx_sign_instr_base_anti_lat & ~indx_sign_instr_base_pro_lat)
pro_anti_lat= sum(indx_sign_instr_base_anti_lat & indx_sign_instr_base_pro_lat)
pro_only_sacc_lat = sum(indx_sign_sacc_base_pro_lat & ~indx_sign_sacc_base_anti_lat)
pro_only_sacc_exc_lat = sum(indx_sign_sacc_base_pro_lat & indx_exc_sacc_pro_lat & ~indx_sign_sacc_base_anti_lat);
pro_only_sacc_sup_lat = sum(indx_sign_sacc_base_pro_lat & indx_sup_sacc_pro_lat & ~indx_sign_sacc_base_anti_lat);
anti_only_sacc_lat = sum(indx_sign_sacc_base_anti_lat & ~indx_sign_sacc_base_pro_lat)
anti_only_sacc_exc_lat = sum(~indx_sign_sacc_base_pro_lat & indx_exc_sacc_anti_lat & indx_sign_sacc_base_anti_lat);
anti_only_sacc_sup_lat= sum(~indx_sign_sacc_base_pro_lat & indx_sup_sacc_anti_lat & indx_sign_sacc_base_anti_lat);
pro_anti_sacc_lat = sum(indx_sign_sacc_base_anti_lat & indx_sign_sacc_base_pro_lat)
pro_anti_sacc_exc_lat = sum(indx_sign_sacc_base_anti_lat & indx_sign_sacc_base_pro_lat & indx_exc_sacc_pro_lat) 
pro_anti_sacc_sup_lat = sum(indx_sign_sacc_base_anti_lat & indx_sign_sacc_base_pro_lat & indx_sup_sacc_pro_lat) 
pro_only_instrDir_lat = sum(indx_sign_instrDir_instr_pro_lat & ~indx_sign_instrDir_instr_anti_lat)
anti_only_instrDir_lat = sum(indx_sign_instrDir_instr_anti_lat & ~indx_sign_instrDir_instr_pro_lat)
pro_anti_instrDir_lat = sum(indx_sign_instrDir_instr_pro_lat & indx_sign_instrDir_instr_anti_lat)
pro_only_goCue_lat = sum(indx_sign_goCue_instrDir_pro_lat & ~indx_sign_goCue_instrDir_anti_lat)
anti_only_goCue_lat = sum(indx_sign_goCue_instrDir_anti_lat & ~indx_sign_goCue_instrDir_pro_lat)
pro_anti_goCue_lat = sum(indx_sign_goCue_instrDir_pro_lat & indx_sign_goCue_instrDir_anti_lat)
pro_sacc_instrDir_lat = sum(indx_sign_saccVSinstrDir_nspk_pro_lat & ~indx_sign_saccVSinstrDir_nspk_anti_lat)
anti_sacc_instrDir_lat = sum(indx_sign_saccVSinstrDir_nspk_anti_lat & ~indx_sign_saccVSinstrDir_nspk_pro_lat)
pro_anti_sacc_instrDir_lat = sum(indx_sign_saccVSinstrDir_nspk_pro_lat & indx_sign_saccVSinstrDir_nspk_anti_lat)
